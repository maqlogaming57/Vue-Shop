            ...
            <div class="mx-auto grid max-w-screen-xl gap-y-8 gap-x-12 px-4 py-10 md:grid-cols-2 xl:grid-cols-4 xl:px-10">
                <div class="max-w-sm">
                    <div class="mb-6 flex h-12 items-center space-x-2">
                        <span class="text-2xl font-bold">Cakayu<span class="text-blue-600">ID</span>.</span>
                    </div>
                    <div class="text-gray-500">Menjadi supplier yang senantiasa berkembang dan mampu bersaing dalam industri global, serta memberikan hasil terbaik dan kepuasan untuk setiap pelanggan.</div>
                </div>
                <div class="">
                    <div class="mt-4 mb-2 font-medium xl:mb-4">Address</div>
                    <div class="text-gray-500">
                        Kp. Lubang Buaya RT 003/001,<br />
                        Kec Setu,<br />
                        Kab. Bekasi
                    </div>
                </div>
